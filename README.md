...
**NOTE : If the above file doesn't work then download from here : [one](https://static.tp-link.com/2018/201808/20180814/Archer%20C6(EU)_V2_180627.zip) .This is the oldest version available.(1.0.1).If you click on the link it will not work , so copy the link and paste it in the url tab and press enter.**
